...
<body >
<!-- multistep form -->
<form id="msform" action="<?php echo base_url()?>/cformabsen/ambil_data_form" method="post">
   <!-- progressbar -->
   ...
   <fieldset style="width:600px;">
      ...
      <table class="tabel" style="margin-left 10%">
            ...
            <?php
               ...
               <td><input type='radio' name='absen<?php echo $i?>' value='Hadir<?php echo $i?>'></td>
               <td><input type='radio' name='absen<?php echo $i?>' value='Izin<?php echo $i?>'></td>
               <td><input type='radio' name='absen<?php echo $i?>' value='Alfa<?php echo $i?>'></td>
