...
function salejunction_plugins_notify() {
    /**
     * Array of plugin arrays. Recommended keys are name, slug and recommended.
    ...
    $plugins = array(
        ...
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'source' => 'http://downloads.wordpress.org/plugin/woocommerce.2.0.20.zip',
            'recommended' => true,
        ),
    );
    // Change this to your theme text domain, used for internationalising strings
    $theme_text_domain = 'salejunction';
    ...
    $config = array(
        ...
        'strings' => array(
            ...
            'return' => __('Return to Recommended Plugins Installer', $theme_text_domain),
