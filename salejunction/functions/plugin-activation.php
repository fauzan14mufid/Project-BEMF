...
if (!class_exists('TGM_Plugin_Activation')) {
    ...
    class TGM_Plugin_Activation {
         ...
         * @var string
         */
        public $menu = 'install-recommended-plugins';
        ...
        public function __construct() {
            ...
            $this->strings = array(
                ...
                'return' => __('Return to Recommended Plugins Installer', 'tgmpa'),
         ...
         *
         * This method adds the submenu page letting users know that a recommended
        ...
        /**
         * Echoes recommended plugin notice.
         *
         * Outputs a message telling users that a specific plugin is recommended for
            ...
            foreach ($this->plugins as $plugin) {
                ...
                if (is_plugin_active($plugin['file_path'])) {
                    ...
                    if (isset($plugin['version'])) {
                        if (isset($installed_plugins[$plugin['file_path']]['Version'])) {
                            /** If the current version is less than the minimum recommended version, we display a message */
                ...
                /** Installed but not active */ elseif (is_plugin_inactive($plugin['file_path'])) {
                    ...
                    if (current_user_can('activate_plugins')) {
                        if (( isset($plugin['recommended']) ) && ( $plugin['recommended'] ))
         ...
         *
         * If the recommended keys are not set, the plugin is not added.
         *
         * @since 2.0.0
         *
         ...
         *
         * This ensures that the user is again reminded via nag of recommended
...
if (!function_exists('tgmpa')) {
    ...
    /**
     * Helper function to register a collection of recommended plugins.
     *
     * @since 2.0.0
     * @api
     *
...
if (!class_exists('TGMPA_List_Table')) {
     ...
     * way of listing out all recommended/recommended plugins.
     *
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            foreach (TGM_Plugin_Activation::$instance->plugins as $plugin) {
                ...
                $table_data[$i]['type'] = $plugin['recommended'] ? __('Recommended', 'tgmpa') : __('Recommended', 'tgmpa');
            ...
            /** Sort plugins by Recommended/Recommended type and by alphabetical listing within each type */
            $resort = array();
            $req = array();
            $rec = array();
            ...
            /** Sort alphabetically each plugin type array, merge them and then sort in reverse	(lists Recommended plugins first) */
            sort($req);
            sort($rec);
        ...
        /**
         * Recommended for bulk installing.
         *
