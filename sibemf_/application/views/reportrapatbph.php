...
<table class="responstable" align="center">
  ...
  <tr>
    ...
    <th width="104">Tempat Rapat</th>
    <th width="99">Tanggal Rapat</th>
       ...
       <!--  <?php
               ...
               foreach($Rapat as $data)
               {
                 // echo "<tr><td td style='text-align:center'> ".$i." </td></td>";
                  echo "<tr><td td style='text-align:center'>".$data->Nama."</td></td>";
                  echo "<td td style='text-align:left'>".$data->Tanggal."</td></td>";
                  echo "<td td style='text-align:left'>".$data->Tempat."</td></td>";
                  echo "<td td style='text-align:left'>".$data->Tempat."</td></td>";
                  //$i++;
               ?>
               <?php 
